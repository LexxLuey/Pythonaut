...
stock = {'shield':(15,25,50), 'sword':(60,60,50),
         'dagger':(25,40,60), 'halberd':(80,75,40),
         'club':(15,40,40), 'flail':(50,60,55),
         'hammer':(99,100,40), 'cuirass':(30,50,20),
         'armour':(101,100,0), 'lantern':(10,5,30),
         'pole':(10,5,50), 'rope':(10,5,70)}
...
def roll(sides, dice = 1):
    ...
    Returns a random number between dice and dice * sides weighted towards the average.
    """
    result = 0
