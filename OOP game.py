...
misses = ('misses', 'nearly hits', 'tickles', 'fumbles', 'fails to connect with', 'swipes wildly at', 'flails ineffectually at', 'gets nowhere near',
          'hurts themself badly as a result of gross stupidity', 'nearly decapitates themself instead of',
          'hits themself on the foot, to the amusement of')
damage_report = ('a small insult', 'a flesh wound', 'a deep gouge',
                 'ragged tearing of skin', 'blood to spurt everywhere','massive head injuries','savage laceration',
...
class Player(GameObject):
    """Role-Playing Character Takes an optional dictionary as an argument.
